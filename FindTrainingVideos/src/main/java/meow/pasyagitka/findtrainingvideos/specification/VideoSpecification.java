package meow.pasyagitka.findtrainingvideos.specification;
...
public class VideoSpecification implements Specification<Video> {
    ...
    public VideoSpecification(SearchDto criteria) {
        super();
    ...
    public Predicate toPredicate
            (Root<Video> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
